...
figure_3 <- ggplot() +
  ...
  annotate(
    ...
    x = maximum_daly_rate * 0.96,
    
    y = maximum_dalys_per_case * 0.97,
    
    label = "Q1\nHigh burden–high severity",
  ...
  labs(
    ...
    title = paste(
      "Country-level colorectal cancer",
      "burden–severity framework in 2023"
    ),
    ...
    caption = paste0(
      ...
      "The x-axis represents population burden; ",
      
      "the y-axis represents average health loss per incident case."
